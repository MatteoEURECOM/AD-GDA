...
def parse_args():
    ...
    parser.add_argument('-m', '--model', default='FullyConnected', choices=['FullyConnected','Logistic'], help='Model architecture')
    parser.add_argument('-b', '--batchsize', default=50,type=int,help='batch size')
    parser.add_argument('-n','--nodes', default=50, type=int, choices=[50,10,5], help='number of network nodes')
    ...
    parser.add_argument('-mu','--mu', default=1.,  type=float,help='regularization parameter')
