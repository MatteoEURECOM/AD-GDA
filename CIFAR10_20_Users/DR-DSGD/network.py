...
parser.add_argument('-n','--nodes', default=20, type=int, choices=[30], help='number of network nodes')
...
parser.add_argument('-etax','--eta_x', default=0.5, type=float, help='primal variable step size')
