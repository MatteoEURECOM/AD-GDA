...
parser.add_argument('-m', '--model', default='CNN', choices=['FullyConnected','Logistic','CNN'], help='Dataset name.')
parser.add_argument('-b', '--batchsize', default=32,help='batch size')
parser.add_argument('-n','--nodes', default=20,  choices=[20], help='number of network nodes')
...
parser.add_argument('-r','--MCReps', default=3, help='number of Monte Carlo repetitions')
parser.add_argument('-pdev','--part_dev', default=10, help='number of participating devices each round')
parser.add_argument('-etax','--eta_x', default=0.1, help='primal variable step size')
...
np.save('DRFA_ROBUST.npy', log, allow_pickle=True)
