...
parser.add_argument('-n','--nodes', default=10,  choices=[20], help='number of network nodes')
...
parser.add_argument('-pdev','--part_dev', default=5, help='number of participating devices each round')
parser.add_argument('-etax','--eta_x', default=0.06, help='primal variable step size')
